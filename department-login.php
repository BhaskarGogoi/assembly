<?php
	...
	echo "<title>Department Login</title>";

?>
</head>

<body id="active-dept-login">
	<?php
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12">
						<div class="login">
							...
							<form class='form-horizontal' role="form" action='includes/department-login.inc.php'
								method='POST'><br>
								...
								<div class='form-group'>
									<div class='col-sm-2'></div>
									<div class='col-sm-8'>
										Contact Admin For Login Credientials
									</div>
								</div>
							</form>
						</div>
