<?php
	...
	echo "<title>Department Log Info</title>";
	...
	function get_row_count() {
		$conn = connect();
		$sql = "SELECT COUNT(*) as row FROM department_login_details";
			...
			<div class="container">
				<div class="row">
						...
						<div class="asideMenuLeft">
							...
							<ul>
								...
								<a href="dept-log-info">
									<li class="active">Department Log Info</li>
								</a>
							</ul>
						</div>
					</div>
					<div class="col-lg-10 col-md-10 col-sm-12">
						<div class="List1">
							<h4>Department Login Info</h4><br>
							<table class="table table-bordered table-striped">
								...
								<tbody>
									<?php
											...
											$sql = "SELECT * FROM department_login_details ORDER BY id desc LIMIT $offset , $per_page_records";
