  ...
  <div class="container">
    ...
    <div  class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-right" id='navBar'>
         <li><a href="//localhost/assembly/assembly-dashboard/">Dashboard</a></li>
                ...
                echo"
                 <li class='dropdown'>
                    ...
                    <ul class='dropdown-menu'>
                        ...
                        <li><a href='//localhost/assembly/assembly-dashboard/insert-user'>User</a></li>
                        <li><a href='//localhost/assembly/assembly-dashboard/departments'>Departments</a></li>
                        <li><a href='//localhost/assembly/assembly-dashboard/sessions'>Session</a></li>
                    </ul>
                </li>
                <li><a href='//localhost/assembly/assembly-dashboard/complaints'>Complaints</a></li>
                <li class='dropdown'>
                    <a href='#'' class='dropdown-toggle' data-toggle = 'dropdown'><i class='fas fa-cog'></i></a>
                    <ul class='dropdown-menu'>                        
                        <li><a href='//localhost/assembly/assembly-dashboard/account'>Account</a></li>
                        <li><a href='//localhost/assembly/assembly-dashboard/log-info'>Log Info</a></li>
                        <li><a href='//localhost/assembly/assembly-dashboard/dept-log-info'>Department Log Info</a></li>
                    </ul>
                </li>
                <li>
